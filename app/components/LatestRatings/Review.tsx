...
export default function Review() {
  return (
    <div className="my-6 flex flex-col gap-x-11 gap-y-5 rounded-lg bg-zinc-100 p-4 md:p-6 xl:flex-row">
      <div className="flex items-start gap-4">
        <Image
          ...
          alt="news_director"
        />
        <div className="flex w-full flex-col sm:flex-row sm:justify-between xl:flex-col">
          <div className="space-x-2 sm:order-last xl:order-none">
