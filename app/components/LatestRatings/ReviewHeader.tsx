...
export default function ReviewHeader() {
  ...
  return (
    <div className="space-y-5">
      <div className="flex flex-row gap-3">
        ...
        <div className="flex-1">
          <div className="flex justify-between gap-3">
            ...
            <div className="mb-4 hidden items-center gap-1 text-base font-medium text-muted-foreground sm:flex">
              {true ? (
      ...
      <div className="mb-4 flex items-center gap-1 text-base font-medium text-muted-foreground sm:hidden">
        {true ? (
          <span className="flex items-center gap-1 text-primary">
            <svg
              width="19"
