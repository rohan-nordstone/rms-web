...
export default function DirectorsSearch() {
  ...
  return (
    <div className="relative flex min-h-[54px] w-full items-center overflow-hidden rounded-[15px] border border-gray-200 bg-white">
      <Input
        ...
        className="h-full min-h-[54px] rounded-l-none border-none px-5 text-base font-light leading-relaxed placeholder:text-zinc-500 "
      />
