...
export default function DropDown({ className, isJobSaved, job }: Props) {
    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent className={cn("", className ?? className)}>
        <DropdownMenuItem onClick={clickHandler}>
          <div className="flex w-full items-center gap-3 text-base font-bold leading-loose text-black">
        ...
        <DropdownMenuItem>
          <SharePopupModal
            className="w-full"
            targetUrl={`${process.env.NEXT_PUBLIC_FRONTEND_URL}/jobs/${job.id}`}
          >
            <div className="flex w-full flex-1 items-center gap-3 text-base font-bold leading-loose text-black">
              <div className="flex h-6 w-6 items-center justify-center">
                <svg
                  width="19"
                  height="21"
