...
export default function page() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      toast.loading("Registering employee...")
      const res = await axios.post(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/auth/register/employee`,
        {
          ...rest,
        }
      )
                  ...
                  <div className="flex gap-3">
                    <FormItem>
                      <FormLabel className="[&:has([data-state=checked])>div]:border-secondary">
                        ...
                        >
                          <div className="text-center text-3xl font-bold leading-relaxed text-secondary">
                            Free
                          </div>
