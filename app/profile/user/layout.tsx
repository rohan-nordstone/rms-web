            ...
            <div className="flex items-center gap-10">
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-3">
                  <span className="text-3xl font-bold leading-[30.50px] text-black">
                ...
                <div>
                  ...
                  <Link
                    ...
                    className="text-[22px] font-semibold leading-relaxed text-black"
                  >
                    KABC
                  </Link>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-lg font-light leading-relaxed text-sky-900">
                    {session?.user?.address ? session?.user?.address : "Los Angeles, CA"}
                  </p>
                </div>
              </div>
            </div>
            <div className="flex flex-col gap-3 sm:flex-row lg:flex-col">
              <Link href={"/profile/user_settings"}>
                <Button
