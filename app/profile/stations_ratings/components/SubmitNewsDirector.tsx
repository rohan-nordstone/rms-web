...
import SubmitNewsDirectorForm from "./SubmitNewsDirectorForm"

type Props = {
  children: ReactNode
}

export default function SubmitNewsDirector({ children }: Props) {
  return (
    <AlertDialog>
