...
export default function LatestRatingFooter() {
  ...
  return (
    <>
      <div className="flex flex-col justify-between gap-5 py-6 md:flex-row md:items-center">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative flex-1">
          ...
          />
          <div className="absolute bottom-0 right-0 top-0 flex items-center justify-center px-5">
            <svg
              width="21"
              height="21"
              viewBox="0 0 21 21"
