...
import EditJobOpening from "./(Job Opening)/EditJobOpening"
import AddNewsDirector from "./(News Director)/AddNewsDirector"
  ...
  return (
    <div className={cn(className && className)}>
      ...
      <div className="relative">
        <ul
          className={`absolute left-0 right-0 top-1 mt-0 space-y-0 rounded-md border bg-white text-sm shadow-md ${
            state ? "" : "hidden"
          }`}
        >
          <EditAbout>
